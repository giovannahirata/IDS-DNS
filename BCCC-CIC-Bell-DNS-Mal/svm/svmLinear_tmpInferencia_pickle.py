...
caminho_modelo_binario = os.path.join(output_dir, 'modelo_binario.pkl')
with open(caminho_modelo_binario, 'wb') as f: # 'wb' = Write Binary
    pickle.dump(linear_svc, f)

caminho_modelo_multi = os.path.join(output_dir, 'modelo_multiclasse.pkl')
with open(caminho_modelo_multi, 'wb') as f:
    pickle.dump(svm_multi_linear, f)
    
# Salvar os objetos de pré-processamento
caminho_scaler = os.path.join(output_dir, 'scaler.pkl')
with open(caminho_scaler, 'wb') as f:
    pickle.dump(scaler, f)

caminho_colunas = os.path.join(output_dir, 'selected_columns.pkl')
with open(caminho_colunas, 'wb') as f:
    pickle.dump(selected_columns, f)

caminho_encoder = os.path.join(output_dir, 'label_encoder_protocol.pkl')
with open(caminho_encoder, 'wb') as f:
    pickle.dump(le, f)
    
caminho_cat_cols = os.path.join(output_dir, 'categorical_columns.pkl')
with open(caminho_cat_cols, 'wb') as f:
