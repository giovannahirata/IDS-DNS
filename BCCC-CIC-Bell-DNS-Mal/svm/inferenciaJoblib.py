...
try:
    modelo_bin = joblib.load(os.path.join(dir, "modelo_binario.joblib"))
    modelo_multi = joblib.load(os.path.join(dir, "modelo_multiclasse.joblib"))
    scaler = joblib.load(os.path.join(dir, "scaler.joblib"))
    final_columns = joblib.load(os.path.join(dir, "selected_columns.joblib"))
    le_protocol = joblib.load(os.path.join(dir, "label_encoder_protocol.joblib"))
    cat_cols = joblib.load(os.path.join(dir, "categorical_columns.joblib"))

except FileNotFoundError as e:
    print(f"Arquivo joblib não encontrado: {e}")
